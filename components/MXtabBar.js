...
const Button = TouchableOpacity//require('./MXbutton');
  ...
  renderTab(item, page, isTabActive, onPressHandler, onLayoutHandler,) {
    ...
    return <Button
      ...
      <View style={[styles.tab, this.props.tabStyle, ]}>
        ...
        {item.icon ? <Icon name={item.icon} size={30} color={textColor} style={{marginRight:5,}}/> : null }
        {item.noLabel ? null : 
    ...
    >
      ...
      >
        ...
        >
         ...
         {false ? <Animated.View style={[tabUnderlineStyle, dynamicTabUnderline, this.props.underlineStyle, ]} /> :null }
        </View>
      </ScrollView>
    </View>;
  },
